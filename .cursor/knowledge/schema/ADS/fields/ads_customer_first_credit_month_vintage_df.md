# ads_customer_first_credit_month_vintage_df

## 表基本信息

| 属性 | 值 |
|------|-----|
| **表名** | `ttsp_it.ads_customer_first_credit_month_vintage_df` |
...
| 迁移时间 | 变更内容 |
|---------|---------|
| 2026-06-16 | 表从 DWS 层迁移至 ADS 层，原 DWS 层文档已归档 |
