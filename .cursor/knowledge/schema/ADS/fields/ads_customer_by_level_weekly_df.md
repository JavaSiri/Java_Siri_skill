...
| 属性 | 值 |
|------|-----|
| **表名** | `ttsp_it.ads_customer_by_level_weekly_df` |
...
周维表字段与月维表 `ads_customer_by_level_monthly_df` 完全一致，共 74 个字段，区别仅在于时间维度为周。
...
### 与 ads_customer_by_annual_rate_weekly_df 的关系
